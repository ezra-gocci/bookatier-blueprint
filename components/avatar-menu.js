...
(function () {
  ...
  var CSS = [
    ...
    '.avm-size-dot[data-set-scale="1"]{width:8px;height:8px;}',
    '.avm-size-dot[data-set-scale="1.2"]{width:11px;height:11px;}',
      ...
      '<div class="avm-theme-row">',
        ...
        '<div class="avm-theme-controls">',
          ...
          '<div class="avm-size-switch" role="group" aria-label="Размер интерфейса">',
            '<button class="avm-size-dot' + (scale === 1   ? ' is-active' : '') + '" type="button" data-set-scale="1"   title="×1.0" aria-label="Размер ×1.0"></button>',
            '<button class="avm-size-dot' + (scale === 1.2 ? ' is-active' : '') + '" type="button" data-set-scale="1.2" title="×1.2" aria-label="Размер ×1.2"></button>',
